...
<head>
    ...
    <title>Sản phẩm Khoáng Chất</title>
...
<div class="container my-5">
    <h1>Danh sách sản phẩm Khoáng Chất</h1>
    <div class="product-list">
        <?php   
        $sql = "SELECT * FROM mat_hang WHERE loai_mat_hang = 'Kháng Chất'";
        $stmt = $ket_noi->prepare($sql);
        $stmt->execute();

        // Lấy tất cả sản phẩm khoáng chất
        ...
        if (count($products) > 0) {
                ...
                <div class="col-md-4 mb-4 product-item" style="background-color: white;">
                   ...
                   if (!empty($imageData)) {
                    ...
                    echo '<img src="data:image/jpeg;base64,' . $imageData . '" alt="Hình ảnh sản phẩm" class="img-fluid" style="width: 200px; height: 200px;">';
                        ...
                        echo '<img src="/anh/sk.png" alt="Hình ảnh mặc định" class="img-fluid" style="width: 200px; height: 200px;">';
                    }
                   ?>
            ...
            echo '<p class="text-center">Không có sản phẩm khoáng chất nào.</p>';
        }
        ?>
    </div>
</div>
